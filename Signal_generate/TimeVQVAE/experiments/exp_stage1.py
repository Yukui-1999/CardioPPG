...
class ExpStage1(pl.LightningModule):
    def __init__(self,
        ...
        # encoder
        self.encoder_l = VQVAEEncoder(init_dim, hid_dim, 2*in_channels, downsample_rate_l, config['encoder']['n_resnet_blocks'], 'lf', self.n_fft, frequency_indepence=False)
        ...
        # decoder
        self.decoder_l = VQVAEDecoder(init_dim, hid_dim, 2*in_channels, downsample_rate_l, config['decoder']['n_resnet_blocks'], input_length, 'lf', self.n_fft, in_channels, frequency_indepence=False)
